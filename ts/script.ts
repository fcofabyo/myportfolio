...
document.querySelectorAll(".skill").forEach((skill) => {
  const htmlElementSkill = skill as HTMLElement; // Cast explícito para HTMLElement
...
document.querySelectorAll(".experience-item").forEach((item) => {
  const htmlElementItem = item as HTMLElement; // Cast explícito para HTMLElement
  htmlElementItem.addEventListener("click", () => {
    ...
    document.querySelectorAll(".experience-item").forEach((el) => {
      const htmlElementEl = el as HTMLElement; // Cast explícito para HTMLElement
    ...
    document.querySelectorAll(".experience-details").forEach((detail) => {
      const htmlElementDetail = detail as HTMLElement; // Cast explícito para HTMLElement
...
document.addEventListener("DOMContentLoaded", () => {
  const atacadaoItem = document.querySelector(
    ".experience-item.atacadao"
  ) as HTMLElement;
  if (atacadaoItem) {
